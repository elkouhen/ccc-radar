...
from archlens.flow import FlowResult
...
from archlens.search import SearchHit, Summary, get_context
from archlens.workspace import DiscoveredService, FederationResult


class FindingHit(TypedDict):
    """Shape returned by `archlens search --json` and the `search_findings` MCP tool."""
...
class FindingsSummary(TypedDict):
    """Shape returned by `archlens summary --json` and the `findings_summary` MCP tool."""
...
class GraphResult(TypedDict):
    """Shape returned by `archlens export microservices --json` and the MCP `graph` tool.
...
def render_graph_likec4(
    ...
    lines = [
        "// Generated by archlens export microservices --c4. Do not edit generated identifiers.",
        "specification {",
...
<body>
  ...
  <script type="module">
    ...
    const pathHistoryStorageKey = (() => {
      ...
      return `archlens:analyzed-paths:${hash >>> 0}`;
    })();
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>ArchLens module dependencies</title>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/graphology/0.25.4/graphology.umd.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sigma.js/2.4.0/sigma.min.js"></script>
  <style>
    :root { color: #172033; background: #f5f7fb; font-family: Inter, ui-sans-serif, system-ui, sans-serif; }
...
def _openapi_contract_evidence_path(endpoint: MessageEndpoint) -> str:
    ...
    for line in endpoint.snippet.splitlines():
        if line.startswith("archlens-openapi-contract:"):
            return line.removeprefix("archlens-openapi-contract:")
...
class WorkspaceResult(TypedDict):
    """Shape returned by `archlens microservices [--root ROOT] --json` and the
