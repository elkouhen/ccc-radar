...
from codeatlas.gradle import discover_gradle_modules
from codeatlas.maven import parse_pom, pom_version
...
def _discover_openapi_files(
    ...
    *,
    ...
    if build_system == "maven" and rest_controllers and pom_path.is_file():
        from codeatlas.maven import detect_openapi_generator_input_specs
...
def _enrich_module(
    ...
    *,
    ...
    if module.build_system == "maven":
        from codeatlas.maven import detect_openapi_generated_clients
